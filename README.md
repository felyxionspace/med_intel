...
- Analisis otomatis Chest X-Ray pasien.
- Prediksi kondisi kesehatan menggunakan model AI.
- Menampilkan **confidence score** untuk hasil prediksi.
- Grad-CAM visualization untuk interpretabilitas model.
- Download laporan PDF profesional dengan hasil analisisnya.
- Website dan mobile support.
